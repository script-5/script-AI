...
if (language == "RU") {
  ...
  var MSG_setmark = WR+"Должен ли этот текстовый объект быть помечен как текущая дата/ время?";
  var MSG_askformat = WR+"Должен ли текстовый объект быть отформатирован как дата/время? Formate:\n{DATE}, {TIME}, {FILE}, {FILEPATH}, {FILENAME} und {FILEEXT}:"
