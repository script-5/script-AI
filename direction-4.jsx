...
//Указатель направления печати при шкале -4 от края артборда
(function main() {
    ...
    // X-позиция: 6 мм от левого края артборда до вершины (верхней точки)
    var obj1_apexX = L - (6 * mm);
    ...
    // X-позиция: 6 мм от правого края до вершины
    var obj2_apexX = R + (6 * mm);
